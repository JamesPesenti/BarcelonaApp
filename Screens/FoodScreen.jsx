...
>
    <ScrollView horizontal={false} showsHorizontalScrollIndicator={false}>
        ...
        <View style={styles.tapaCard}>
            ...
            >
                <Image style={{ position: "absolute", width: 90, height: 90, left: 2, marginTop: 10, paddingTop: 40, marginBottom: 50, borderRadius: 100, borderColor: "white", borderWidth: .5}} source={{uri: "https://blog.amigofoods.com/wp-content/uploads/2020/05/tapas-dishes-spelling-tapas.jpg"}}/>
                    <Text style={{fontWeight: "bold", fontSize: 17, color: 'white', marginTop: 36, right: 3, textAlign: 'center'}}>The Origin of Tapas</Text>         
                    <Text style={{lineHeight: 23, fontWeight: "bold", fontSize: 14, color: 'white', marginTop: 40, textAlign: 'center'}}
                ...
                <Image style={{ backgroundColor: "white", position: "absolute", width: 90, height: 90, right: 2, marginTop: 10, paddingTop: 40, marginBottom: 50, borderRadius: 100, borderColor: "white", borderWidth: .5}} source={{uri: "https://thefoodolic.files.wordpress.com/2017/06/firsttapadraw1.png?w=384&h=354"}}/>
            </ImageBackground>
        </View>
