    ...
    <ScrollView horizontal={false} showsHorizontalScrollIndicator={false}>
        ...
        <View style={styles.tapaCard}>
            ...
            >
                ...
                <Image style={{ backgroundColor: "white", position: "absolute", width: 88, height: 88, right: 8, margin: -2, paddingTop: 40, marginBottom: 0, borderRadius: 100, borderColor: "white", borderWidth: .5}} source={{uri: "https://thefoodolic.files.wordpress.com/2017/06/firsttapadraw1.png?w=384&h=354"}}/>
            </ImageBackground>
        </View>
