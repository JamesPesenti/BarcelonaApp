        ...
        <View style={styles.tapaCard}>
            ...
            >
                <Image style={{ position: "absolute", width: 88, height: 88, left: 2, margin: 0, paddingTop: 40, marginBottom: 50, borderRadius: 100, borderColor: "white", borderWidth: .5}} source={{uri: "https://blog.amigofoods.com/wp-content/uploads/2020/05/tapas-dishes-spelling-tapas.jpg"}}/>
                    <Text style={{fontWeight: "bold", fontSize: 17, color: 'white', marginTop: 16, right: 3, textAlign: 'center'}}>The Origin of Tapas</Text>         
                ...
                <Image style={{ backgroundColor: "white", position: "absolute", width: 88, height: 88, right: 8, margin: 0, paddingTop: 40, marginBottom: 50, borderRadius: 100, borderColor: "white", borderWidth: .5}} source={{uri: "https://thefoodolic.files.wordpress.com/2017/06/firsttapadraw1.png?w=384&h=354"}}/>
            </ImageBackground>
        </View>
